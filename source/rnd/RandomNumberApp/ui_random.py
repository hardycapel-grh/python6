...
################################################################################
## Form generated from reading UI file 'random_ui.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.generateButton.setGeometry(QRect(30, 210, 93, 29))
        self.numberLabel = QLabel(self.centralwidget)
        self.numberLabel.setObjectName(u"numberLabel")
        self.numberLabel.setGeometry(QRect(160, 210, 63, 20))
        self.resetButton = QPushButton(self.centralwidget)
        self.resetButton.setObjectName(u"resetButton")
        self.resetButton.setGeometry(QRect(30, 260, 93, 29))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.numberLabel.setText(QCoreApplication.translate("MainWindow", u"0", None))
