"""Autogenerated module docstring for access/ui/components/logger.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.225068Z
"""
...
# Note: `logger` and `ui_tree_logger` are configured with file handlers
# only, and duplicate handler installation is prevented by checking
# `logger.handlers` and `ui_tree_logger.handlers`.
# This avoids repeated log entries when the module is imported multiple times.
