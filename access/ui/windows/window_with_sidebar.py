"""Autogenerated module docstring for access/ui/windows/window_with_sidebar.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:24.219384Z
"""
...
class WindowWithSidebar(QMainWindow):
    ...
    def add_page(self, label, factory, required_permission=None):
        # Determine active user safely. This class can be subclassed by windows
        # that provide either `current_user` or `user` depending on their init.
        ...
        # Permission gating: pages requiring permissions are only exposed if
        # the current user holds that permission or a wildcard admin grant.
