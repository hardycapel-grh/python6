"""Autogenerated module docstring for access/ui/dialogs/permission_editor_dialog.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.342912Z
"""
...
class PermissionEditorDialog(QDialog):
    ...
    def load_permission(self):
        ...
        # Name is locked on edit to avoid renaming which would require
        # careful migration of references; keep edits limited to metadata.
    ...
    def save(self):
        ...
        try:
            # Delegate persistence + auditing to the mongo service. The
            # service handles sanitization and writing audit entries.
            if self.mode == "add":
            ...
            # Surface DB/service errors to the user via modal dialog.
