"""Autogenerated module docstring for access/ui/dialogs/profile_dialogs.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.344914Z
"""
...
class ProfileDialog(QDialog):
    ...
    # NOTE: Profile updates are audited by the service layer. Avoid
    # including sensitive user data (passwords, tokens) in the `fields`
    # passed to `update_profile`. This dialog only exposes non-sensitive
    # preferences.
...
class ChangePasswordDialog(QDialog):
    ...
    # IMPORTANT: Passwords are handled by the `MongoService.change_password`
    # implementation which must never log raw passwords. The UI should pass
    # only the password values to the secure service call and rely on the
    # service to perform hashing and auditing (with redaction) safely.