"""Autogenerated module docstring for access\ui\pages\admin\roles_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.603828Z
"""
...
class RolesPage(QWidget):
    ...
    def add_role(self):
        if not self.app.has_permission("roles.create"):
            # Deny access when the user lacks the required capability.
    ...
    # Note: Role editing operations are routed through the service layer
    # which performs validation and writes audit entries. Role names are
    # treated as identifiers and should not be freely renamed; editor
    # dialogs typically lock the name field for edits.
    ...
    # --- Permission enforcement ---
        ...
        if confirm == QMessageBox.Yes:
            # Deletions are performed via the service which will also write
            # an audit entry describing the removal for traceability.
