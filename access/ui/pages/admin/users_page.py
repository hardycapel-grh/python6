"""Autogenerated module docstring for access/ui/pages/admin/users_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.897041Z
"""
...
class UsersPage(QWidget):
    def __init__(self, user, mongo, parent=None):
        ...
        self.search_input.setPlaceholderText("Search usersa")
    ...
    def load_users(self):
        try:
            logger.info("Loading users from MongoDBa")
        ...
        # Note: the model stores the full user documents; sensitive fields
        # (password hashes) should not be displayed in the table and are
        # intentionally omitted by the `UsersTableModel.data()` method.
    ...
    def _edit_selected_user(self):
        ...
        dialog.saved.connect(self.load_users)   # a refresh automatically  
        dialog.exec()
