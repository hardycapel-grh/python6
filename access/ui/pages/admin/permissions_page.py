"""Autogenerated module docstring for access/ui/pages/admin/permissions_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.578817Z
"""
...
class PermissionsPage(QWidget):
    ...
    def refresh(self):
        ...
        # Note: Permission documents may include internal metadata used for
        # auditing or UI grouping; only the user-friendly fields are shown
        # here to avoid cluttering the admin view with implementation details.
    ...
    def add_permission(self):
        if not self.app.has_permission("permissions.create"):
            # Prevent access if user lacks the create permission.
    ...
    # --- Permission enforcement ---
        ...
        if confirm == QMessageBox.Yes:
            # Delete operation delegates to the mongo service which will
            # perform safety checks and write an audit entry.
