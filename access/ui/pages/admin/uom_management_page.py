"""Autogenerated module docstring for access/ui/pages/admin/uom_management_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.850669Z
"""
...
class UomManagementPage(QWidget):
    ...
    def _check_permissions(self):
        ...
        if not admin_window or not admin_window.has_permission("uom.manage"):
            # If the current user lacks permission to manage UOMs, present
            # a simple message and disable the view to prevent accidental
            # interaction with the management controls.
    ...
    def _load_data(self):
        ...
        # Note: Quantity type controls whether the application treats values
        # as integers (no fractional parts) or decimals. This influences
        # validators and rounding elsewhere (BOM quantities, stock counts).
    ...
    def _add_uom(self):
        ...
        try:
            ...
            # Record UOM creation in the audit log and file logger. The
            # mongo service will sanitize any details before persisting.
    ...
    # NOTE: UOM create/update/delete actions are audited so administrators
    # can track unit changes. The `uom` documents are referenced by
    # inventory items — `_uom_in_use` prevents accidental deletion while in
    # use to avoid orphaning inventory entries.
    ...
    def _delete_selected(self):
        ...
        try:
            ...
            # Deletion is audited so administrators can see when units are
            # removed and by whom.
            self.mongo.log_event(
                "uom.delete",
                performed_by=self.user.username,
