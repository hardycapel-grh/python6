"""Autogenerated module docstring for access\ui\pages\admin\bom_editor_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.547891Z
"""
...
class BOMEditorPage(QWidget):
    ...
    def _save_bom_to_db(self, bom_data):
        # NOTE: UI-level logging for user action; audit entry is written
        # after the DB insert below so the audit reflects a successful save.
        log_event(
            "info",
            "Saving BOM",
        ...
        try:
            ...
            # Audit: record the completed save. Stored details are
            # sanitized by the MongoService before insertion.
    ...
    def _auto_increment_revision(self):
        ...
        # Flag to prevent UI change events from triggering save/load while
        # we programmatically update the editor controls.
        ...
        # Convert revision values to integers where possible — non-numeric
        # revisions are ignored for auto-increment behaviour.
        numeric_boms = []
        ...
        # NOTE: Revisions are treated as numeric when they parse as integers.
        # Legacy or semantic revisions like 'A', 'B', or 'rev1' are ignored
        # for the purpose of auto-incrementing to avoid changing human-facing
        # revision schemes. When a numeric next revision is determined the
        # revision selector is replaced with that value and disabled so the
        # user cannot accidentally choose an out-of-sequence revision.
    ...
    def _load_bom_into_editor(self, bom_doc):
        ...
        # Prevent dirty flag during auto-load: we are populating UI from
        # stored data and do not want these programmatic changes to mark
        # the editor as "dirty".
