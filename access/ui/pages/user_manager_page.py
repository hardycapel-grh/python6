"""Autogenerated module docstring for access/ui/pages/user_manager_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.492596Z
"""
...
class UserManagerPage(QWidget):
    ...
    # NOTE: The UI strips internal fields (password hashes, internal flags)
    # before displaying user rows. Any operation that mutates user state
    # (reset password, force change) delegates to secure service methods
    # that must perform hashing and auditing safely; the UI should not
    # perform cryptographic operations itself.
    ...
    def on_row_double_clicked(self, item):
        ...
        dlg = EditUserDialog(
            user_doc=user_data,
            current_user=self.current_user,   # a pass it in
            parent=self
        )
        dlg.exec()