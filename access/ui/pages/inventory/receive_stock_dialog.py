"""Autogenerated module docstring for access/ui/pages/inventory/receive_stock_dialog.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:24.138645Z
"""
...
class ReceiveStockDialog(QDialog):
    def __init__(self, mongo, user, item, parent=None):
        ...
        self.setWindowTitle(f"Receive Stock a {item['part_number']}")
    ...
    def _save(self):
        ...
        try:
            ...
            # Audit log
            # Insert the batch first, then write an audit entry describing
            # the action. The `mongo` service will sanitize/redact any
            # sensitive values before persisting the audit document.
