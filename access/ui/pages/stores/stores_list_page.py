"""Autogenerated module docstring for access\ui\pages\stores\stores_list_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:24.173706Z
"""
...
class StoresListPage(QWidget):
    ...
    def _add_store(self):
        ...
        if dlg.exec() == QDialog.Accepted:
            ...
            # Write audit after successful insert so the audit reflects a
            # persisted change. The service/sanitizer will redact sensitive
            # fields if present.
            self.mongo.audit(
                "store.create",
                self.user.username,
    ...
    def _delete_store(self):
        ...
        # WARNING: Deleting stores can orphan inventory/batch documents.
        # The TODO above should be addressed by preventing deletes when
        # related batches or inventory references exist, or by performing
        # a careful cascade/transfer. For now the delete is performed and
        # audited immediately after the DB operation.
