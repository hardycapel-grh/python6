"""Autogenerated module docstring for access/ui/pages/login_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.414401Z
"""
...
class LoginWindow(QWidget):
    ...
    def login(self):
        ...
        if updated:
            # Auto-repair missing fields: bring older user documents up to
            # date. Note: this performs a permissions update call for
            # convenience a the service layer will audit this change.
            self.mongo.update_permissions(username, db_user["permissions"])
            logger.info(f"Auto-repaired missing fields for user '{username}'")

        # -------------------------------------------------
        # Convert dict a User object
        # -------------------------------------------------
        ...
        # IMPORTANT: Do not log passwords or secrets. All audit messages here
        # are high-level and avoid including sensitive values.
        # -------------------------------------------------
        # Open MainApp
        # -------------------------------------------------
