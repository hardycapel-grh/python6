"""Autogenerated module docstring for access/ui/pages/permission_editor_page.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:23.442402Z
"""
...
class PermissionEditorPage(QWidget):
    ...
    def __init__(self, current_user, parent=None):
        ...
        self.user_cache = {}   # username a User object
        self.checkboxes = {}   # feature a {read: QCheckBox, write: QCheckBox}
    ...
    # NOTE: We construct a lightweight `User` object for UI convenience.
    # This object mirrors permissions stored in the DB; changing permissions
    # in the UI writes the new permission list back to the `users` document.
    # Be careful: permission grants are powerful a only users with the
    # appropriate admin capability should be allowed to make changes.
    ...
    def save_permissions(self):
        ...
        # Audit the permission change after a successful DB update so the
        # audit reflects the persisted state. The MongoService will apply
        # any configured sanitization before storing the audit record.
        self.mongo.audit(
