"""Autogenerated module docstring for access/ui/widgets/bom_line_row.py

Description: TODO - add a meaningful module description.
Generated: 2026-08-01T21:47:24.207139Z
"""
...
class BOMLineRow(QWidget):
    ...
    def __init__(self, items_list: list[dict], parent=None):
        ...
        # Any text change in the part selector should mark this row as
        # modified so parent editors can enable the Save button.
    ...
    def _update_uom(self):
        ...
        # a REQUIRED for dirty flag
        # Emit changed so the parent editor knows this row's selection altered
        # (which can affect UOM, quantity rounding rules, etc.).
        self.changed.emit()


    def _on_remove(self):
        # Request parent to remove this widget; parent will handle layout
        # cleanup. Also emit `changed` so the editor's dirty flag updates.
        self.remove_requested.emit(self)
        self.changed.emit()  # NEW a removing a row marks dirty
